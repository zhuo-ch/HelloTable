...
json.favorites do
  json.array! user.favorites do |favorite|
    ...
    json.set! :restaurant do
      ...
      json.extract! favorite.restaurant, :id, :restaurant_name, :cuisine, :address, :location
      json.ratings do
...
json.reservations user.reservations do |reservation|
    ...
    json.restaurant do
      ...
      json.extract! reservation.restaurant, :id, :restaurant_name, :cuisine, :address, :location
      json.ratings do
